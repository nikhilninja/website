import {
  ...
  ReleasesPage,
  getBadgeProps
} from "./chunk-Z2CK5VUT.js";
import {
  utcToZonedTime
} from "./chunk-F5JNUXNF.js";
import {
  ReleaseActionMenu,
...
`;
var ButtonContent = gt(C)`
  svg {
    fill: currentColor;
  }
`;
var CustomStatusButton = ({ children, icon, color }) => {
  return (0, import_jsx_runtime.jsx)(Xd.Trigger, {
    children: (0, import_jsx_runtime.jsx)(Ct, {
      variant: "ghost",
      endIcon: (0, import_jsx_runtime.jsx)(p2, {}),
  ...
  if (action === "publish") {
    if (hasErrors || requiredStage && requiredStage.id !== (entryStage == null ? void 0 : entryStage.id)) {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, {
        icon: (0, import_jsx_runtime.jsx)(R5, {}),
        color: "danger600",
    ...
    if (status === "draft") {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, {
        icon: (0, import_jsx_runtime.jsx)(w5, {}),
        color: "success600",
        children: formatMessage({
    ...
    if (status === "modified") {
      return (0, import_jsx_runtime.jsx)(CustomStatusButton, {
        icon: (0, import_jsx_runtime.jsx)(W2, {}),
    ...
    children: [
      (0, import_jsx_runtime.jsxs)(C, {
        ...
        children: [
          ...
          hasErrors ? (0, import_jsx_runtime.jsx)(R5, {
            fill: "danger600"
          }) : (0, import_jsx_runtime.jsx)(w5, {
            fill: "success600"
          })
        ]
      }),
      ...
      hasErrors && (0, import_jsx_runtime.jsx)(Hd, {
        tag: Link,
        to: {
...
var EntryValidationPopover = ({ schema, entry, status, action }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Xd.Root, {
    children: [
      ...
      (0, import_jsx_runtime.jsx)(Xd.Content, {
...
var ReleaseDetailsLayout = ({ toggleEditReleaseModal, toggleWarningSubmit, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Layouts.Root, {
    children: (0, import_jsx_runtime2.jsxs)(Vd, {
      "aria-busy": isLoadingDetails,
      children: [
        (0, import_jsx_runtime2.jsx)(Layouts.Header, {
          title: release.name,
          subtitle: (0, import_jsx_runtime2.jsxs)(C, {
            gap: 2,
            lineHeight: 6,
            children: [
          ...
          primaryAction: !release.releasedAt && (0, import_jsx_runtime2.jsxs)(C, {
            gap: 2,
            children: [
              (0, import_jsx_runtime2.jsxs)(SimpleMenuButton, {
                label: (0, import_jsx_runtime2.jsx)(W3, {}),
                variant: "tertiary",
                endIcon: null,
                paddingLeft: "7px",
                paddingRight: "7px",
                ...
                children: [
                  (0, import_jsx_runtime2.jsx)(gd.Item, {
                    disabled: !canUpdate,
                    onSelect: toggleEditReleaseModal,
                    startIcon: (0, import_jsx_runtime2.jsx)(nn, {}),
                    children: formatMessage({
                  ...
                  (0, import_jsx_runtime2.jsx)(gd.Item, {
                    ...
                    variant: "danger",
                    startIcon: (0, import_jsx_runtime2.jsx)(In, {}),
                    children: formatMessage({
              ...
              canPublish ? (0, import_jsx_runtime2.jsx)(Ct, {
                size: "S",
                variant: "default",
...
var ReleaseDetailsBody = ({ releaseId }) => {
  ...
  if (Object.keys(releaseActions).length === 0) {
    return (0, import_jsx_runtime2.jsx)(Layouts.Content, {
      children: (0, import_jsx_runtime2.jsx)(Wd, {
        action: (0, import_jsx_runtime2.jsx)(Hd, {
          tag: Link,
          to: {
    ...
    children: (0, import_jsx_runtime2.jsxs)(C, {
      ...
      children: [
        (0, import_jsx_runtime2.jsx)(C, {
          children: (0, import_jsx_runtime2.jsx)(cr, {
            ...
            children: options.map((option) => (0, import_jsx_runtime2.jsx)(dr, {
              value: option,
              children: formatMessage(getGroupByOptionLabel(option))
            }, option))
          })
        }),
        Object.keys(releaseActions).map((key) => (0, import_jsx_runtime2.jsxs)(C, {
          gap: 4,
          direction: "column",
          alignItems: "stretch",
          children: [
            (0, import_jsx_runtime2.jsx)(C, {
              role: "separator",
              "aria-label": key,
              children: (0, import_jsx_runtime2.jsx)(Nr, {
                children: key
              })
            }),
              ...
              children: (0, import_jsx_runtime2.jsxs)(Table.Content, {
                children: [
                  ...
                  (0, import_jsx_runtime2.jsx)(Table.Body, {
                    children: releaseActions[key].map(({ id, contentType, locale, type, entry, status }, actionIndex) => (0, import_jsx_runtime2.jsxs)(fu, {
                      children: [
                        (0, import_jsx_runtime2.jsx)(pu, {
                          width: "25%",
                          maxWidth: "200px",
                        ...
                        hasI18nEnabled && (0, import_jsx_runtime2.jsx)(pu, {
                          width: "10%",
                          children: (0, import_jsx_runtime2.jsx)(A, {
                        ...
                        (0, import_jsx_runtime2.jsx)(pu, {
                          width: "20%",
                          children: release.releasedAt ? (0, import_jsx_runtime2.jsx)(A, {
                            children: formatMessage({
                              id: "content-releases.page.ReleaseDetails.table.action-published",
                              defaultMessage: "This entry was <b>{isPublish, select, true {published} other {unpublished}}</b>."
                            }, {
                              isPublish: type === "publish",
                              b: (children) => (0, import_jsx_runtime2.jsx)(A, {
                                fontWeight: "bold",
                                children
                              })
                            })
...
//# sourceMappingURL=App-DSFRQM6W.js.map
