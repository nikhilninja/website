import {
  PrivateRoute
} from "./chunk-JTL2E7MA.js";
import {
  hideCloudDeployMenuLinkInProduction
} from "./chunk-O6WGVCXB.js";
import {
  NpsSurvey
...
var package_default = {
  ...
  scripts: {
    ...
    "test:ts:back": "run -T tsc -p server/tsconfig.json && run -T tsc -p ee/server/tsconfig.json",
  ...
  devDependencies: {
    "@strapi/admin-test-utils": "5.52.0",
    "@strapi/data-transfer": "5.52.0",
...
var IconImpl = ({ label, children }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Le, {
    label,
    children
  });
};
var CustomBadge = gt(Nr)`
...
var MainNavIcons = ({ listLinks, mobileLinks, handleClickOnLink }) => {
  ...
  return listLinks.length > 0 ? listLinks.map((link) => {
    ...
    const badgeContentLock = (link == null ? void 0 : link.licenseOnly) ? (0, import_jsx_runtime3.jsx)(F3, {
      fill: "primary600"
    }) : void 0;
    ...
    return isDesktop || !isDesktop && linkMobile ? (0, import_jsx_runtime3.jsx)(C, {
      tag: "li",
...
var NavUser = ({ initials, showDisplayName = false, children, ...props }) => {
  ...
  return (0, import_jsx_runtime16.jsx)(C, {
    ...props,
    children: (0, import_jsx_runtime16.jsxs)(gd.Root, {
      children: [
          ...
          children: (0, import_jsx_runtime16.jsxs)(C, {
            ...
            children: [
              (0, import_jsx_runtime16.jsx)(MenuIcon, {
                justifyContent: "center",
                children: (0, import_jsx_runtime16.jsx)(hd.Item, {
                  delayMs: 0,
                  fallback: initials || getInitials(user)
                })
              }),
              showDisplayName ? (0, import_jsx_runtime16.jsx)(A, {
                variant: "omega",
                children: children || userDisplayName
              }) : (0, import_jsx_runtime16.jsx)($e, {
                tag: "span",
                children: children || userDisplayName
              })
            ]
            ...
            (0, import_jsx_runtime16.jsxs)(UserInfo, {
              ...
              children: [
                ...
                (0, import_jsx_runtime16.jsx)(BadgeWrapper, {
                  children: (_a = user == null ? void 0 : user.roles) == null ? void 0 : _a.map((role) => (0, import_jsx_runtime16.jsx)(Nr, {
                    children: role.name
                  }, role.id))
                })
              ]
            }),
            (0, import_jsx_runtime16.jsx)(gd.Separator, {}),
            (0, import_jsx_runtime16.jsx)(gd.Item, {
...
var NavBurgerMenu = ({ isShown, handleClickOnLink, onClose, listLinks }) => {
  return (0, import_jsx_runtime17.jsx)(un, {
    children: (0, import_jsx_runtime17.jsx)(AnimatePresence, {
      children: isShown && (0, import_jsx_runtime17.jsx)(yu, {
        onEscape: onClose,
        children: (0, import_jsx_runtime17.jsx)(MotionLayer, {
          ...
          children: (0, import_jsx_runtime17.jsx)(Surface, {
            children: (0, import_jsx_runtime17.jsx)(st2, {
              children: (0, import_jsx_runtime17.jsxs)(C, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime17.jsx)(S, {
                    tag: "li",
                    children: (0, import_jsx_runtime17.jsx)(yn, {})
                  }),
                  (0, import_jsx_runtime17.jsx)(S, {
                    paddingLeft: 2,
                    paddingRight: 2,
...
var TrialCountdown = () => {
  ...
  return (0, import_jsx_runtime18.jsx)(Container, {
    justifyContent: "center",
    padding: 3,
    children: (0, import_jsx_runtime18.jsx)(Mt, {
    ...
    children: [
      (0, import_jsx_runtime19.jsxs)(MainNav, {
        children: [
          ...
          isDesktop && (0, import_jsx_runtime19.jsx)(yn, {}),
          ...
          (0, import_jsx_runtime19.jsx)(S, {
            ...
            children: (0, import_jsx_runtime19.jsx)(be, {
              ...
              children: !isBurgerMenuShown ? (0, import_jsx_runtime19.jsx)(B3, {
                fill: "neutral1000"
              }) : (0, import_jsx_runtime19.jsx)(F5, {
                fill: "neutral1000"
              })
            })
          })
    ...
    children: [
      (0, import_jsx_runtime21.jsx)(BannerBackground, {
        ...
        children: (0, import_jsx_runtime21.jsxs)(C, {
          ...
          gap: 2,
          children: [
            (0, import_jsx_runtime21.jsxs)(S, {
              children: [
                (0, import_jsx_runtime21.jsx)(A, {
                  variant: "delta",
                  fontWeight: "bold",
                  textColor: "neutral0",
                  textAlign: "center",
            ...
            (0, import_jsx_runtime21.jsx)(S, {
              children: (0, import_jsx_runtime21.jsx)(Hd, {
                width: "max-content",
                variant: "tertiary",
      ...
      (0, import_jsx_runtime21.jsx)(FixedButtonWrapper, {
        children: (0, import_jsx_runtime21.jsx)(be, {
          withTooltip: false,
          label: formatMessage({
          ...
          onClick: onDismiss,
          children: (0, import_jsx_runtime21.jsx)(F5, {})
        })
      })
    ]
  });
  ...
  if (isDismissed) {
    return (0, import_jsx_runtime21.jsx)(FixedButtonWrapper, {
      children: (0, import_jsx_runtime21.jsx)(be, {
        ...
        children: (0, import_jsx_runtime21.jsx)(Q2, {})
      })
    });
  }
...
var useMenu = (shouldUpdateStrapi, currentEnvironment) => {
  var _a;
  const checkUserHasPermissions = useAuth("useMenu", (state) => state.checkUserHasPermissions, true);
  ...
  React7.useEffect(() => {
    async function applyMenuPermissions() {
      ...
      setMenuWithUserPermissions((state) => ({
        ...
        pluginsSectionLinks: hideCloudDeployMenuLinkInProduction(authorizedPluginSectionLinks, currentEnvironment),
        isLoading: false
      }));
    }
...
var AdminLayout = () => {
  ...
  const { trackUsage } = useTracking();
  const { isLoading: isLoadingMenu, generalSectionLinks, pluginsSectionLinks, topMobileNavigation, burgerMobileNavigation } = useMenu(checkLatestStrapiVersion(strapiVersion, tagName), appInfo == null ? void 0 : appInfo.currentEnvironment);
    ...
    children: [
      ...
      (0, import_jsx_runtime22.jsx)(PluginsInitializer, {
        children: (0, import_jsx_runtime22.jsx)(DndProvider, {
          ...
          children: (0, import_jsx_runtime22.jsxs)(S, {
            background: "neutral100",
            children: [
              (0, import_jsx_runtime22.jsx)(jd, {
                children: formatMessage({
                  id: "skipToContent",
                  defaultMessage: "Skip to content"
                })
              }),
              (0, import_jsx_runtime22.jsxs)(C, {
                height: "100dvh",
                direction: {
                  initial: "column",
                  large: "row"
                ...
                children: [
                  ...
                  (0, import_jsx_runtime22.jsxs)(C, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime22.jsx)(LazyOutlet, {
                        suspenseOnly: true
                      })
                    ]
                  })
...
//# sourceMappingURL=AuthenticatedLayout-TEB6IVBP.js.map
