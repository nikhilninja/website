import {
  Permissions
} from "./chunk-QJADA6SV.js";
import "./chunk-TPW47I4W.js";
import "./chunk-ZOFYVLW7.js";
import {
  useAdminRoles
} from "./chunk-UQAD3G5W.js";
...
var EditPage = () => {
  ...
  const handleEditRoleSubmit = async (data, formik) => {
    var _a, _b, _c;
    if ((_a = permissionsRef.current) == null ? void 0 : _a.hasLocaleValidationErrors()) {
      return;
    }
    try {
      const { permissionsToSend, didUpdateConditions } = ((_b = permissionsRef.current) == null ? void 0 : _b.getPermissions()) ?? {};
      ...
      (_c = permissionsRef.current) == null ? void 0 : _c.setFormAfterSubmit();
      await refetchRole();
      toggleNotification({
        type: "success",
  ...
  return (0, import_jsx_runtime2.jsxs)(Vd, {
    children: [
...
//# sourceMappingURL=EditPage-SLJQ35NV.js.map
