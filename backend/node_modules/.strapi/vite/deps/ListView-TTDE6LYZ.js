  ...
  return (0, import_jsx_runtime5.jsxs)(ComponentBox, {
    ...
    children: [
      ...
      isInDevelopmentMode && !disabled && (0, import_jsx_runtime5.jsx)(CloseButton, {
        ...
        tag: "button",
        onClick: onClose,
        children: (0, import_jsx_runtime5.jsx)(F5, {})
      })
    ]
  });
};
...
var DynamicZoneList = ({ components = [], addComponent, name, forTarget, targetUid, disabled = false }) => {
  ...
  return (0, import_jsx_runtime6.jsx)(ComponentRow, {
    ...
    children: (0, import_jsx_runtime6.jsxs)(S, {
      children: [
        ...
        (0, import_jsx_runtime6.jsx)(S, {
          children: components.map((component, index) => {
            return (0, import_jsx_runtime6.jsx)(S, {
        ...
        children: [
          (0, import_jsx_runtime7.jsxs)(C, {
            ...
            children: [
              ...
              isInDevelopmentMode && (0, import_jsx_runtime7.jsx)(be, {
                cursor,
                role: "Handle",
                ref: handleRef,
                ...listeners,
                ...
                children: (0, import_jsx_runtime7.jsx)(q5, {})
              }),
              (0, import_jsx_runtime7.jsxs)(C, {
                gap: 4,
                children: [
                  (0, import_jsx_runtime7.jsxs)(C, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime7.jsxs)(A, {
                        ...
                        children: [
                          item.name,
                          "required" in item && item.required && (0, import_jsx_runtime7.jsx)(A, {
                            textColor: "danger600",
                            children: "* "
                          })
                        ]
                  ...
                  (0, import_jsx_runtime7.jsx)(C, {
                    children: (0, import_jsx_runtime7.jsxs)(A, {
                      ...
                      children: [
                        ...
                        "conditions" in item && item.conditions && Object.keys(item.conditions).length > 0 && (0, import_jsx_runtime7.jsx)(Nr, {
                          margin: 4,
                        ...
                        item.type === "relation" && (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                          children: [
                            ...
                            " ",
                            targetContentType && (0, import_jsx_runtime7.jsx)(Oa, {
          ...
          (0, import_jsx_runtime7.jsx)(S, {
            children: (0, import_jsx_runtime7.jsx)(C, {
              ...
              children: (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                children: [
                  ...
                  [
                    "component",
                    "dynamiczone"
                  ].includes(item.type) && (0, import_jsx_runtime7.jsx)(be, {
                    onClick: (e) => {
                      e.preventDefault();
                      e.stopPropagation();
                      if (isOpen) {
                    ...
                    variant: "ghost",
                    withTooltip: false,
                    children: (0, import_jsx_runtime7.jsx)(o5, {
                      "aria-hidden": true,
                      fill: "neutral500",
                      style: {
                  ...
                  isInDevelopmentMode && item.configurable !== false ? (0, import_jsx_runtime7.jsxs)(import_jsx_runtime7.Fragment, {
                    children: [
                      !isMorph && (0, import_jsx_runtime7.jsx)(be, {
                        onClick: handleClick,
                        label: `${formatMessage({
                          id: "app.utils.edit",
                          defaultMessage: "Edit"
                        ...
                        variant: "ghost",
                        disabled: !canEdit,
                        children: (0, import_jsx_runtime7.jsx)(nn, {})
                      }),
                      (0, import_jsx_runtime7.jsx)(be, {
                        ...
                        variant: "ghost",
                        disabled: !canDelete,
                        children: (0, import_jsx_runtime7.jsx)(In, {})
                      }),
                      (0, import_jsx_runtime7.jsx)(Pd.Root, {
                    ...
                    padding: 2,
                    children: (0, import_jsx_runtime7.jsx)(z3, {
                      fill: "neutral500"
                    })
                  })
                ]
  ...
  return (0, import_jsx_runtime9.jsxs)(DndContext, {
    ...
    children: [
      ...
      isMain && isInDevelopmentMode && (0, import_jsx_runtime9.jsx)(TFooter, {
        ...
        icon: (0, import_jsx_runtime9.jsx)(en, {}),
        onClick: onClickAddField,
...
var LinkToCMSettingsView = (0, import_react4.memo)(({ disabled, type }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(StyledButton, {
    startIcon: (0, import_jsx_runtime10.jsx)(V3, {}),
    variant: "tertiary",
    onClick: handleClick,
    disabled,
    children: label
...
var ListView = () => {
  ...
  const primaryAction = isInDevelopmentMode && (0, import_jsx_runtime11.jsxs)(C, {
    gap: 2,
    children: [
      ...
      (0, import_jsx_runtime11.jsx)(Ct, {
        startIcon: (0, import_jsx_runtime11.jsx)(nn, {}),
        variant: "tertiary",
        onClick: onEdit,
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, {
    children: [
      (0, import_jsx_runtime11.jsx)(tours.contentTypeBuilder.Introduction, {
        children: (0, import_jsx_runtime11.jsx)(S, {})
      }),
      isDeleted && (0, import_jsx_runtime11.jsx)(C, {
...
//# sourceMappingURL=ListView-TTDE6LYZ.js.map
