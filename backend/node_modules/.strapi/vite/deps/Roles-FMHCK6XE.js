...
import {
  require_sortBy
} from "./chunk-JGHVLH7T.js";
import {
  require_map,
  require_tail
} from "./chunk-LI7F4VN4.js";
...
import "./chunk-WG5V2M3Y.js";
import "./chunk-7FM3VPGA.js";
import "./chunk-PAY54OVR.js";
import "./chunk-6FPRH5OA.js";
import "./chunk-FB3TFNYO.js";
import "./chunk-7WYSAWLA.js";
import "./chunk-TGL3FZCW.js";
import "./chunk-OOCFQHA2.js";
import "./chunk-X5O7QAHT.js";
import "./chunk-EBVWQ5LF.js";
import "./chunk-F4UX6LX2.js";
import "./chunk-VJGQCFQV.js";
import "./chunk-PMQHZHNW.js";
import "./chunk-APZFFNDF.js";
import "./chunk-JZDXFZNR.js";
import "./chunk-RV33B7LL.js";
import "./chunk-4TY22IQS.js";
import "./chunk-QAHMOFNT.js";
import "./chunk-PDGPTUUZ.js";
import "./chunk-UZRPIKEE.js";
import "./chunk-CKHVVMRE.js";
import "./chunk-WR5S3Z6I.js";
import "./chunk-5QJFIL32.js";
import "./chunk-FNEDWASG.js";
import "./chunk-OIM6YED5.js";
import "./chunk-4TGPRBPZ.js";
import "./chunk-AT2I3J2U.js";
import "./chunk-B4OGK5RU.js";
import "./chunk-LTCOPNPJ.js";
import "./chunk-KDNKE2TZ.js";
...
var SubCategory = ({ subCategory }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(S, {
    children: [
      (0, import_jsx_runtime2.jsxs)(C, {
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsx)(S, {
            paddingLeft: 4,
            children: (0, import_jsx_runtime2.jsx)(Bt, {
      ...
      (0, import_jsx_runtime2.jsx)(C, {
        paddingTop: 6,
        paddingBottom: 6,
        children: (0, import_jsx_runtime2.jsx)(Ld.Root, {
          gap: 2,
          style: {
            flex: 1
          },
          children: subCategory.actions.map((action) => {
            ...
            return (0, import_jsx_runtime2.jsx)(Ld.Item, {
              col: 4,
              xs: 12,
              s: 6,
              direction: "column",
...
var Permissions = () => {
  ...
  return (0, import_jsx_runtime4.jsx)(dd.Root, {
    size: "M",
    children: (0, import_jsx_runtime4.jsx)(C, {
      direction: "column",
      alignItems: "stretch",
      gap: 1,
      children: collapses.map((collapse, index) => (0, import_jsx_runtime4.jsxs)(dd.Item, {
        value: collapse.name,
        children: [
          (0, import_jsx_runtime4.jsx)(dd.Header, {
            variant: index % 2 === 0 ? "secondary" : void 0,
            children: (0, import_jsx_runtime4.jsx)(dd.Trigger, {
              caretPosition: "right",
          ...
          (0, import_jsx_runtime4.jsx)(dd.Content, {
      ...
      (0, import_jsx_runtime5.jsxs)(C, {
        ...
        children: [
          ...
          (0, import_jsx_runtime5.jsx)(S, {
            paddingLeft: 2,
            paddingRight: 2,
            children: (0, import_map.default)(formattedRoute, (value) => (0, import_jsx_runtime5.jsxs)(A, {
...
var Policies = () => {
  ...
  return (0, import_jsx_runtime6.jsx)(Ld.Item, {
    ...
    direction: "column",
    alignItems: "stretch",
    children: selectedAction ? (0, import_jsx_runtime6.jsx)(C, {
      direction: "column",
      alignItems: "stretch",
      gap: 2,
...
var UsersPermissions$1 = (0, import_react7.forwardRef)(({ permissions, routes }, ref) => {
  ...
  return (0, import_jsx_runtime7.jsx)(UsersPermissionsProvider, {
    value: providerValue,
    children: (0, import_jsx_runtime7.jsxs)(Ld.Root, {
      gap: 0,
      shadow: "filterShadow",
      hasRadius: true,
      background: "neutral0",
      children: [
        (0, import_jsx_runtime7.jsx)(Ld.Item, {
          col: 7,
          xs: 12,
          paddingTop: 6,
          paddingBottom: 6,
          ...
          direction: "column",
          alignItems: "stretch",
          children: (0, import_jsx_runtime7.jsxs)(C, {
            direction: "column",
            alignItems: "stretch",
            gap: 6,
            children: [
              (0, import_jsx_runtime7.jsxs)(C, {
                direction: "column",
                alignItems: "stretch",
                gap: 2,
                children: [
        ...
        children: ({ handleSubmit, values, handleChange, errors }) => (0, import_jsx_runtime8.jsxs)(Form, {
          ...
          children: [
            (0, import_jsx_runtime8.jsx)(Layouts.Header, {
              primaryAction: !isLoadingPlugins && (0, import_jsx_runtime8.jsx)(Ct, {
                type: "submit",
                loading: mutation.isLoading,
                startIcon: (0, import_jsx_runtime8.jsx)(h5, {}),
                fullWidth: true,
                children: formatMessage({
                  id: "global.save",
                  defaultMessage: "Save"
                ...
                children: [
                  (0, import_jsx_runtime8.jsxs)(C, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime8.jsxs)(Ld.Root, {
                        gap: 4,
                        children: [
                          (0, import_jsx_runtime8.jsx)(Ld.Item, {
                            col: 6,
                            xs: 12,
                            direction: "column",
                            alignItems: "stretch",
                            children: (0, import_jsx_runtime8.jsxs)(Dd.Root, {
                              name: "name",
                              ...
                              required: true,
                              children: [
                                (0, import_jsx_runtime8.jsx)(Dd.Label, {
                                  children: formatMessage({
                                    id: "global.name",
                                    defaultMessage: "Name"
                                  })
                                }),
                                (0, import_jsx_runtime8.jsx)(Pc, {
                                  type: "text",
                                  value: values.name || "",
                                  onChange: handleChange
                                }),
                                (0, import_jsx_runtime8.jsx)(Dd.Error, {})
                              ]
                            })
                          }),
                          (0, import_jsx_runtime8.jsx)(Ld.Item, {
        ...
        children: ({ handleSubmit, values, handleChange, errors }) => (0, import_jsx_runtime9.jsxs)(Form, {
          ...
          children: [
            (0, import_jsx_runtime9.jsx)(Layouts.Header, {
              primaryAction: !isLoadingPlugins ? (0, import_jsx_runtime9.jsx)(Ct, {
                disabled: role.code === "strapi-super-admin",
                type: "submit",
                loading: mutation.isLoading,
                startIcon: (0, import_jsx_runtime9.jsx)(h5, {}),
                fullWidth: true,
                children: formatMessage({
                  id: "global.save",
                  defaultMessage: "Save"
            ...
            (0, import_jsx_runtime9.jsx)(Layouts.Content, {
              children: (0, import_jsx_runtime9.jsxs)(C, {
                background: "neutral0",
                direction: "column",
                alignItems: "stretch",
                gap: 7,
                ...
                children: [
                  (0, import_jsx_runtime9.jsxs)(C, {
                    ...
                    children: [
                      ...
                      (0, import_jsx_runtime9.jsxs)(Ld.Root, {
                        gap: 4,
                        children: [
                          (0, import_jsx_runtime9.jsx)(Ld.Item, {
                            col: 6,
                            xs: 12,
                            direction: "column",
                            alignItems: "stretch",
                            children: (0, import_jsx_runtime9.jsxs)(Dd.Root, {
                              name: "name",
                              error: (errors == null ? void 0 : errors.name) ? formatMessage({
                                id: errors.name,
                                defaultMessage: "Name is required"
                              ...
                              required: true,
                              children: [
                                (0, import_jsx_runtime9.jsx)(Dd.Label, {
                                  children: formatMessage({
                                    id: "global.name",
                                    defaultMessage: "Name"
                                  })
                                }),
                                (0, import_jsx_runtime9.jsx)(Pc, {
                                  type: "text",
                                  value: values.name || "",
                                  onChange: handleChange
                                }),
                                (0, import_jsx_runtime9.jsx)(Dd.Error, {})
                              ]
                            })
                          }),
                          (0, import_jsx_runtime9.jsx)(Ld.Item, {
...
var TableBody = ({ sortedRoles, canDelete, canUpdate, setRoleToDelete, onDelete }) => {
  ...
  return (0, import_jsx_runtime10.jsx)(uu, {
    children: sortedRoles == null ? void 0 : sortedRoles.map((role) => (0, import_jsx_runtime10.jsxs)(fu, {
      cursor: "pointer",
      onClick: () => navigate(role.id.toString()),
      children: [
        (0, import_jsx_runtime10.jsx)(pu, {
          width: "20%",
        ...
        (0, import_jsx_runtime10.jsx)(pu, {
          children: (0, import_jsx_runtime10.jsxs)(C, {
            justifyContent: "end",
            ...
            children: [
              canUpdate ? (0, import_jsx_runtime10.jsx)(EditLink, {
                ...
                children: (0, import_jsx_runtime10.jsx)(nn, {})
              }) : null,
              checkCanDeleteRole(role) && (0, import_jsx_runtime10.jsx)(be, {
                ...
                children: (0, import_jsx_runtime10.jsx)(In, {})
              })
            ]
          })
        })
  ...
  return (0, import_jsx_runtime11.jsxs)(Page.Main, {
    children: [
      ...
      (0, import_jsx_runtime11.jsx)(Layouts.Header, {
        ...
        primaryAction: canCreate ? (0, import_jsx_runtime11.jsx)(Hd, {
          to: "new",
          tag: NavLink,
          onClick: () => trackUsage("willCreateRole"),
          startIcon: (0, import_jsx_runtime11.jsx)(en, {}),
          size: "S",
          fullWidth: true,
          children: formatMessage({
      ...
      (0, import_jsx_runtime11.jsxs)(Layouts.Content, {
        children: [
          ...
          canRead && sortedRoles && (sortedRoles == null ? void 0 : sortedRoles.length) ? (0, import_jsx_runtime11.jsxs)(du, {
            colCount,
            rowCount,
            children: [
              (0, import_jsx_runtime11.jsx)(hu, {
                children: (0, import_jsx_runtime11.jsxs)(fu, {
                  children: [
                    (0, import_jsx_runtime11.jsx)(gu, {
                    ...
                    (0, import_jsx_runtime11.jsx)(gu, {
                      children: (0, import_jsx_runtime11.jsx)($e, {
                        children: formatMessage({
                          id: "global.actions",
          ...
          }) : (0, import_jsx_runtime11.jsx)(Wd, {
            content: formatMessage(emptyLayout[emptyContent])
          })
        ]
      }),
      (0, import_jsx_runtime11.jsx)(Pd.Root, {
...
//# sourceMappingURL=Roles-FMHCK6XE.js.map
