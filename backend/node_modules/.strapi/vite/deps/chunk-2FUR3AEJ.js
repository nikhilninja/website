...
var GenericTableProvider = TableProvider;
var Root = ({ children, defaultSelectedRows, footer, headers = [], isLoading = false, onSelectedRowsChange, rows = [], selectedRows: selectedRowsProps }) => {
  ...
  return (0, import_jsx_runtime.jsx)(GenericTableProvider, {
    colCount,
    hasHeaderCheckbox,
...
var Head = ({ children }) => {
  return (0, import_jsx_runtime.jsx)(hu, {
...
var Empty = (props) => {
  ...
  return (0, import_jsx_runtime.jsx)(uu, {
    children: (0, import_jsx_runtime.jsx)(fu, {
      children: (0, import_jsx_runtime.jsx)(pu, {
        colSpan: colCount,
        children: (0, import_jsx_runtime.jsx)(Wd, {
...
var Row = (props) => {
  return (0, import_jsx_runtime.jsx)(fu, {
    ...props
  });
};
var Cell = (props) => {
  return (0, import_jsx_runtime.jsx)(pu, {
    ...props
  });
};
var CheckboxCell = ({ id, ...props }) => {
  ...
  const handleSelectRow = () => {
    const row = rows.find((row2) => row2.id === id);
    if (row !== void 0) {
      selectRow(row);
    }
  };
...
//# sourceMappingURL=chunk-2FUR3AEJ.js.map
