...
var EventsHeaders = ({ getHeaders = getCEHeaders }) => {
  ...
  return (0, import_jsx_runtime.jsx)(jl, {
    children: (0, import_jsx_runtime.jsxs)(Ul, {
      children: [
        (0, import_jsx_runtime.jsx)(Vl, {
        ...
        headers.map((header) => {
          if ([
            ...
            return (0, import_jsx_runtime.jsx)(Vl, {
              title: formatMessage({
...
var EventsBody = ({ providedEvents }) => {
  ...
  return (0, import_jsx_runtime.jsx)(_l, {
...
var EventsRow = ({ disabledEvents = [], name, events = [], inputValue = [], handleSelect, handleSelectAll }) => {
  ...
  return (0, import_jsx_runtime.jsxs)(Ul, {
    children: [
      ...
      events.map((event) => {
        return (0, import_jsx_runtime.jsx)(Dn, {
          textAlign: "center",
      ...
      events.length < targetColumns && (0, import_jsx_runtime.jsx)(Dn, {
...
//# sourceMappingURL=chunk-5ELTHIJE.js.map
