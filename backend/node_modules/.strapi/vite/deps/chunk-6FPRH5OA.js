...
var getStageColorByHex = (hex) => {
  ...
  const themeColors = Object.entries(nn.colors).filter(([, value]) => value.toUpperCase() === hex.toUpperCase());
...
var AVAILABLE_COLORS = Object.entries(STAGE_COLORS).map(([themeColorName, name]) => ({
  hex: nn.colors[themeColorName].toUpperCase(),
  name
}));
...
//# sourceMappingURL=chunk-6FPRH5OA.js.map
