...
} from "./chunk-EWO32YW2.js";
import {
  require_pick
} from "./chunk-MRC7Q4L6.js";
import {
  getBasename
} from "./chunk-TKXHHSNW.js";
import {
  Login
} from "./chunk-6V3Z4PTD.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-VY3HSRI2.js";
import {
  ConfigurationProvider
} from "./chunk-KS6JQKZD.js";
import {
  useClipboard
...
import {
  useGetAiUsageQuery
} from "./chunk-SMDBRE2T.js";
import {
  useEnterprise
} from "./chunk-D6PI2SBB.js";
import {
  _setPrototypeOf
...
import {
  ...
  TrackingProvider,
  useTracking
} from "./chunk-YODH24KF.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-CVIFBHEI.js";
import {
  require_isEqual
...
var Theme = ({ children, themes }) => {
  ...
  return (0, import_jsx_runtime3.jsxs)(Bd, {
    locale,
    /**
  ...
  return (0, import_jsx_runtime5.jsx)(Providers, {
    ...
    children: (0, import_jsx_runtime5.jsxs)(import_react12.Suspense, {
      ...
      children: [
        ...
        window.strapi.future.isEnabled("betaMediaLibrary") && globalComponents.map(({ name, Component }) => (0, import_jsx_runtime5.jsx)(Component, {}, name)),
...
// node_modules/@strapi/admin/dist/admin/admin/src/utils/retryDynamicImport.mjs
var CHUNK_LOAD_ERROR_RE = /Failed to fetch dynamically imported module|Importing a module script failed|error loading dynamically imported module|Loading chunk \d+ failed|ChunkLoadError/i;
...
async function retryDynamicImport(importer, options = {}) {
  ...
  for (let attempt = 0; attempt < maxAttempts; attempt++) {
    try {
      ...
      await sleep2(exponential + jitter);
    }
  }
  throw lastError;
}
function wrapRouteObjectLazyWithRetry(route) {
  const next = {
    ...route
  };
  if (route.lazy) {
...
function wrapRouteObjectsLazyWithRetry(routes) {
...
\`\`\`
    ...
    if (isChunkLoadError(error)) {
      return (0, import_jsx_runtime6.jsx)(Vd, {
        height: "100%",
        children: (0, import_jsx_runtime6.jsx)(C, {
          alignItems: "center",
          height: "100%",
          ...
          children: (0, import_jsx_runtime6.jsxs)(C, {
            ...
            hasRadius: true,
            children: [
              (0, import_jsx_runtime6.jsxs)(C, {
                direction: "column",
                gap: 2,
                children: [
                  (0, import_jsx_runtime6.jsx)(l5, {
                    width: "32px",
                    height: "32px",
                    fill: "primary600"
                  }),
                  ...
                  (0, import_jsx_runtime6.jsx)(A, {
                    ...
                    children: formatMessage({
                      ...
                      defaultMessage: "The admin could not load a screen. This often happens when the server is starting or the connection was interrupted. Reload the page to try again. If you recently deployed, you may need a full refresh to load the latest version."
                    })
                  })
                ]
              }),
              (0, import_jsx_runtime6.jsxs)(C, {
                ...
                children: [
                  ...
                  (0, import_jsx_runtime6.jsx)(StyledAlert, {
                    ...
                    closeLabel: "",
                    variant: "warning",
                    children: (0, import_jsx_runtime6.jsx)(ChunkErrorType, {
                  ...
                  (0, import_jsx_runtime6.jsx)(Ct, {
                    onClick: handleCopy,
                    variant: "tertiary",
                    startIcon: (0, import_jsx_runtime6.jsx)(y5, {}),
                    children: formatMessage({
                      id: "app.error.copy",
              ...
              children: [
                ...
                (0, import_jsx_runtime6.jsx)(A, {
                  ...
                  children: formatMessage({
                    ...
                    link: (0, import_jsx_runtime6.jsx)(Oa, {
                      isExternal: true,
  ...
  return (0, import_jsx_runtime7.jsxs)(Page.Main, {
    ...
    children: [
      ...
      (0, import_jsx_runtime7.jsx)(Layouts.Content, {
        children: (0, import_jsx_runtime7.jsx)(Wd, {
          action: (0, import_jsx_runtime7.jsx)(Hd, {
            tag: Link,
            variant: "secondary",
            endIcon: (0, import_jsx_runtime7.jsx)(I2, {}),
            to: "/",
            children: formatMessage({
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-C76YAQTL.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-4KUWZEH2.js");
        return {
...
var ForgotPassword = () => {
  ...
  return (0, import_jsx_runtime8.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime8.jsxs)(Vd, {
      children: [
          ...
          children: [
            (0, import_jsx_runtime8.jsxs)(Column, {
              children: [
                ...
                error ? (0, import_jsx_runtime8.jsx)(A, {
        ...
        (0, import_jsx_runtime8.jsx)(C, {
          justifyContent: "center",
          children: (0, import_jsx_runtime8.jsx)(S, {
            paddingTop: 4,
            children: (0, import_jsx_runtime8.jsx)(Oa, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
  ...
  return (0, import_jsx_runtime9.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime9.jsxs)(Vd, {
      children: [
        ...
        (0, import_jsx_runtime9.jsx)(C, {
          justifyContent: "center",
          children: (0, import_jsx_runtime9.jsx)(S, {
            paddingTop: 4,
            children: (0, import_jsx_runtime9.jsx)(Oa, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
    ...
    children: (0, import_jsx_runtime10.jsxs)(Vd, {
      children: [
        ...
        (0, import_jsx_runtime10.jsx)(C, {
          justifyContent: "center",
          children: (0, import_jsx_runtime10.jsx)(S, {
            paddingTop: 4,
            children: (0, import_jsx_runtime10.jsx)(Oa, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.signin",
...
var isMessageDescriptor = (value) => {
  return isRecord(value) && typeof value.id === "string" && typeof value.defaultMessage === "string";
};
var formatValidationMessage = (msg, formatMessage) => {
  const format = ({ values, ...message }) => formatMessage(message, values);
  try {
    if (msg === void 0 || msg === null) return "";
...
var Register = ({ hasAdmin }) => {
  ...
  return (0, import_jsx_runtime11.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime11.jsxs)(LayoutContent, {
      children: [
        (0, import_jsx_runtime11.jsxs)(C, {
          direction: "column",
          alignItems: "center",
          gap: 3,
          children: [
            (0, import_jsx_runtime11.jsx)(Logo, {}),
            (0, import_jsx_runtime11.jsx)(A, {
              tag: "h1",
              variant: "alpha",
              textAlign: "center",
              children: formatMessage({
            ...
            apiError ? (0, import_jsx_runtime11.jsx)(A, {
              id: "global-form-error",
              role: "alert",
              tabIndex: -1,
              textColor: "danger600",
        ...
        (0, import_jsx_runtime11.jsx)(Form, {
          ...
          children: (0, import_jsx_runtime11.jsxs)(C, {
            ...
            marginTop: 7,
            children: [
              (0, import_jsx_runtime11.jsx)(Ld.Root, {
                gap: 4,
                children: [
                  {
                    label: formatMessage({
                  ...
                  },
                  {
                    label: formatMessage({
                      ...
                      terms: (0, import_jsx_runtime11.jsx)(A2, {
                        target: "_blank",
                      ...
                      policy: (0, import_jsx_runtime11.jsx)(A2, {
                        target: "_blank",
                ...
                ].map(({ size, ...field }) => (0, import_jsx_runtime11.jsx)(Ld.Item, {
                  xs: 12,
                  m: size,
                  direction: "column",
                  alignItems: "stretch",
        ...
        (match == null ? void 0 : match.params.authType) === "register" && (0, import_jsx_runtime11.jsx)(S, {
          paddingTop: 4,
          children: (0, import_jsx_runtime11.jsx)(C, {
            justifyContent: "center",
            children: (0, import_jsx_runtime11.jsx)(Oa, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
...
var ResetPassword = () => {
  ...
  return (0, import_jsx_runtime12.jsx)(UnauthenticatedLayout, {
    children: (0, import_jsx_runtime12.jsxs)(Vd, {
      children: [
          ...
          children: [
            (0, import_jsx_runtime12.jsxs)(Column, {
              children: [
                ...
                error ? (0, import_jsx_runtime12.jsx)(A, {
                  id: "global-form-error",
                  role: "alert",
                  tabIndex: -1,
                  textColor: "danger600",
            ...
            (0, import_jsx_runtime12.jsx)(Form, {
              ...
              children: (0, import_jsx_runtime12.jsxs)(C, {
                direction: "column",
                alignItems: "stretch",
                gap: 6,
                children: [
        ...
        (0, import_jsx_runtime12.jsx)(C, {
          justifyContent: "center",
          children: (0, import_jsx_runtime12.jsx)(S, {
            paddingTop: 4,
            children: (0, import_jsx_runtime12.jsx)(Oa, {
              tag: NavLink,
              to: "/auth/login",
              children: formatMessage({
                id: "Auth.link.ready",
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await retryDynamicImport(() => import("./Login-KFJMI626.js"))).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await retryDynamicImport(() => import("./constants-5GJQHNNI.js"))).FORMS, {
...
var ADMIN_TOKEN_ROUTES = [
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-RCYNWHLY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-XFWWNNMC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-IMOL7RJX.js");
      return {
...
var ROUTES_CE = () => [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-U4C4EQYG.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-46GUKPEO.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-SLJQ35NV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-7V5VGS4U.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-DEMNJUJL.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-USKIOZ47.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-WYULHZFI.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UZGTUXQ4.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-MWOBD55M.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-TOEOCT3R.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-HA5RIFQ7.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-EFLW3HSA.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-622XT7SY.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-WJR5PEUA.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-5YXN574A.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-JCKGCFVY.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-7AMFAEMI.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-DCXKOKBO.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-WV52DNVO.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-H6KIOWTY.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-JDQMBSIQ.js");
      return {
  ...
  },
  {
    path: "me/sessions",
    lazy: async () => {
      const { SessionsPage } = await import("./SessionsPage-CB5JBNKH.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-FM26ZR2B.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-FLBMQGBC.js");
          return {
  ...
  */
  createRouter(strapi, { memory, ...opts } = {}) {
    const authenticatedLayoutRoute = {
      path: "/*",
      lazy: async () => {
        const { PrivateAdminLayout } = await import("./AuthenticatedLayout-TEB6IVBP.js");
        return {
...
function __variableDynamicImportRuntime5__(path) {
  switch (path) {
    ...
    case "./translations/en.json":
      return import("./en.json-7KFFDTX2.js");
    ...
    case "./translations/pl.json":
      return import("./pl.json-JNXVIQG6.js");
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-XZDZ6FQ5.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
  ...
  async register(customRegister) {
    const widgets = [
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-P66QSLQ6.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-P66QSLQ6.js");
    ...
    if ("strapi-cloud" in this.appPlugins) {
      widgets.push({
        ...
        component: async () => {
          const { DeployNowWidget } = await import("./Widgets-P66QSLQ6.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-HCOCNZSX.js");
...
// node_modules/@strapi/admin/dist/admin/admin/src/utils/getProjectType.mjs
var getProjectType = ({ isEE, planPriceId }) => {
  if (!isEE) {
    return "Community";
  }
  if (planPriceId == null ? void 0 : planPriceId.toLowerCase().includes("growth")) {
    return "Growth";
  }
  return "Enterprise";
};
...
var renderAdmin = async (mountNode, { plugins, customisations, features }) => {
  ...
  try {
    const { data: { data: { isEE, isTrial, features: features2, flags, ai, planPriceId } } } = await get("/admin/project-type");
    ...
    window.strapi.projectType = getProjectType({
      isEE,
      planPriceId
    });
    window.strapi.ai = ai;
  ...
  return (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, {
    children: [
      descriptions.map((description) => {
        ...
        return (0, import_jsx_runtime17.jsx)(MemoizedDescription, {
          id: key,
          description,
          props,
          update
...
var Description = ({ description, id, props, update }) => {
...
var MemoizedDescription = React15.memo(Description, (prev, next) => (0, import_isEqual.default)(prev.props, next.props));
var ids = /* @__PURE__ */ new WeakMap();
var counter = 0;
function getCompId(comp) {
  const cachedComponent = comp;
...
//# sourceMappingURL=chunk-EWOWJQ4I.js.map
