...
var StepCount = ({ tourName, displayedCurrentStep, displayedTourLength }) => {
  ...
  return (0, import_jsx_runtime2.jsx)(A, {
    variant: "omega",
    fontSize: "12px",
...
var GotItAction = ({ onClick }) => {
  return (0, import_jsx_runtime2.jsx)(Ct, {
    onClick,
    children: (0, import_jsx_runtime2.jsx)(message_default, {
      id: "tours.gotIt",
...
var DefaultActions = ({ showSkip, showPrevious, to, tourName, onNextStep, onPreviousStep }) => {
  ...
  return (0, import_jsx_runtime2.jsxs)(C, {
    gap: 2,
    children: [
      showSkip && (0, import_jsx_runtime2.jsx)(Ct, {
        variant: "tertiary",
        onClick: handleSkip,
        children: (0, import_jsx_runtime2.jsx)(message_default, {
          id: "tours.skip",
      ...
      !showSkip && showPrevious && (0, import_jsx_runtime2.jsx)(Ct, {
        variant: "tertiary",
      ...
      to ? (0, import_jsx_runtime2.jsx)(Hd, {
        tag: NavLink,
        to,
...
var ActionsContainer = gt(C)`
  border-top: ${({ theme }) => `1px solid ${theme.colors.neutral150}`};
`;
var ContentContainer = gt(S)`
  p {
...
var createStepComponents = (tourName) => ({
  ...
  Title: (props) => {
    return (0, import_jsx_runtime2.jsx)(S, {
      ...
      paddingBottom: 1,
      width: "100%",
      children: "children" in props ? props.children : (0, import_jsx_runtime2.jsx)(A, {
        tag: "h1",
...
var CopyAPIToken = ({ Step, dispatch }) => (0, import_jsx_runtime3.jsxs)(Step.Root, {
  ...
  children: [
    ...
    (0, import_jsx_runtime3.jsx)(Step.Content, {
      ...
      values: {
        spacer: (0, import_jsx_runtime3.jsx)(S, {
          paddingTop: 2
        }),
        a: (msg) => (0, import_jsx_runtime3.jsx)(Oa, {
          isExternal: true,
...
var GuidedTourOverlay = gt(S)`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
  bottom: 0;
  background-color: ${({ theme }) => ln(theme.colors.neutral800, 0.2)};
  z-index: 10;
`;
var GuidedTourTooltipImpl = ({ children, content, tourName, step, when }) => {
  ...
  React3.useEffect(() => {
    ...
    (_a2 = anchorRef.current) == null ? void 0 : _a2.scrollIntoView({
      behavior: "instant",
      block: "center"
    });
  ...
  return (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, {
    children: [
      isPopoverOpen && (0, import_jsx_runtime6.jsx)(un, {
        children: (0, import_jsx_runtime6.jsx)(GuidedTourOverlay, {})
      }),
      (0, import_jsx_runtime6.jsxs)(Xd.Root, {
        open: isPopoverOpen,
        children: [
          (0, import_jsx_runtime6.jsx)(Xd.Anchor, {
            ref: anchorRef,
            children
          }),
          content({
...
//# sourceMappingURL=chunk-HAVY7JHW.js.map
