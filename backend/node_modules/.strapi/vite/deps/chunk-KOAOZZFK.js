    ...
    children: (0, import_jsx_runtime.jsxs)(Form, {
      ...
      children: [
        (0, import_jsx_runtime.jsx)(_d.Header, {
          children: (0, import_jsx_runtime.jsxs)(C, {
            ...
            children: [
              ...
              (0, import_jsx_runtime.jsx)(_d.Title, {
        ...
        (0, import_jsx_runtime.jsx)(_d.Body, {
          children: (0, import_jsx_runtime.jsx)(Ld.Root, {
            gap: 4,
            children: [
              {
                name: "label",
            ...
            ].filter(filterFieldsBasedOnAttributeType(attribute.type)).map(({ size, ...field }) => (0, import_jsx_runtime.jsx)(Ld.Item, {
              col: size,
              xs: 12,
              direction: "column",
              alignItems: "stretch",
            ...
            children: [
              containers.map((container, containerIndex) => (0, import_jsx_runtime2.jsx)(SortableContext, {
                ...
                children: (0, import_jsx_runtime2.jsx)(DroppableContainer, {
                  id: container.dndId,
                  children: ({ setNodeRef }) => (0, import_jsx_runtime2.jsx)(Ld.Root, {
                    ref: setNodeRef,
                    gap: 2,
                    children: container.children.map((child, childIndex) => (0, import_jsx_runtime2.jsx)(Ld.Item, {
                      col: child.size,
                      xs: 12,
                      direction: "column",
                      alignItems: "stretch",
              ...
              (0, import_jsx_runtime2.jsxs)(gd.Root, {
                children: [
                  (0, import_jsx_runtime2.jsx)(gd.Trigger, {
                    startIcon: (0, import_jsx_runtime2.jsx)(en, {}),
                    endIcon: null,
                  ...
                  (0, import_jsx_runtime2.jsx)(gd.Content, {
                    children: remainingFields.map((field) => (0, import_jsx_runtime2.jsx)(gd.Item, {
...
var Field = ({ attribute, components, name, onRemoveField, dndId }) => {
  ...
  if (value.name === TEMP_FIELD_NAME) {
    return (0, import_jsx_runtime2.jsx)(C, {
      tag: "span",
      height: "100%",
      style: {
        opacity: 0
  ...
  return (0, import_jsx_runtime2.jsxs)(_d.Root, {
    open: isModalOpen,
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsxs)(C, {
            ...
            children: [
              ...
              (attribute == null ? void 0 : attribute.type) === "component" ? (0, import_jsx_runtime2.jsxs)(C, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
                ...
                children: [
                  (0, import_jsx_runtime2.jsx)(Ld.Root, {
                    gap: 4,
                    width: "100%",
                    children: components[attribute.component].layout.map((row) => row.map(({ size, ...field }) => (0, import_jsx_runtime2.jsx)(Ld.Item, {
                      col: size,
                      xs: 12,
                      direction: "column",
                      alignItems: "stretch",
              ...
              (attribute == null ? void 0 : attribute.type) === "dynamiczone" ? (0, import_jsx_runtime2.jsx)(C, {
                paddingTop: 3,
                paddingRight: 3,
                paddingBottom: 3,
                paddingLeft: 0,
...
var ConfigurationForm = ({ attributes, fieldSizes, layout: editLayout, onSubmit }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, {
    children: (0, import_jsx_runtime3.jsx)(Vd, {
          ...
          (0, import_jsx_runtime3.jsx)(Layouts.Content, {
            children: (0, import_jsx_runtime3.jsxs)(C, {
              ...
              children: [
                ...
                (0, import_jsx_runtime3.jsxs)(Ld.Root, {
                  gap: 4,
                  children: [
...
var addTmpSpaceToLayout = (layout) => layout.map((row) => {
...
var Header = ({ name }) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Layouts.Header, {
    ...
    primaryAction: (0, import_jsx_runtime3.jsx)(Ct, {
      disabled: !modified,
...
//# sourceMappingURL=chunk-KOAOZZFK.js.map
