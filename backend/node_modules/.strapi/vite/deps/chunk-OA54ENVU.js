...
} from "./chunk-VKLIDOGS.js";
import {
  ApiTokenBox,
  FormHead
} from "./chunk-I334URTR.js";
import {
  useCreateAPITokenMutation,
  useGetAPITokenQuery,
  useUpdateAPITokenMutation
} from "./chunk-FTESKDH5.js";
import {
  API_TOKEN_TYPE,
  apiTokenInformationSchema
} from "./chunk-LI4MATFC.js";
import {
  require_baseRest
      ...
      (0, import_jsx_runtime2.jsxs)(C, {
        ...
        children: [
          ...
          (0, import_jsx_runtime2.jsx)(S, {
            paddingLeft: 2,
            paddingRight: 2,
            children: (0, import_map.default)(formattedRoute, (value) => (0, import_jsx_runtime2.jsxs)(A, {
...
var ActionBoundRoutes = () => {
  ...
  return (0, import_jsx_runtime3.jsx)(Ld.Item, {
    xs: 12,
    m: 5,
    col: 5,
    ...
    direction: "column",
    alignItems: "stretch",
    children: selectedAction ? (0, import_jsx_runtime3.jsx)(C, {
      direction: "column",
      alignItems: "stretch",
      gap: 2,
...
var CollapsableContentType = ({ controllers = [], label, orderNumber = 0, disabled = false }) => {
  ...
  return (0, import_jsx_runtime4.jsxs)(dd.Item, {
            ...
            children: [
              ...
              (0, import_jsx_runtime4.jsx)(Ld.Root, {
                ...
                children: (controller == null ? void 0 : controller.actions) && (controller == null ? void 0 : controller.actions.map((action) => {
                  return (0, import_jsx_runtime4.jsx)(Ld.Item, {
                    xs: 12,
                    s: 6,
                    direction: "column",
                    alignItems: "stretch",
...
var ContentTypesSection = ({ section = null, ...props }) => {
  return (0, import_jsx_runtime5.jsx)(S, {
    children: (0, import_jsx_runtime5.jsx)(dd.Root, {
      size: "M",
...
var Permissions = ({ ...props }) => {
  ...
  const { formatMessage } = useIntl();
  return (0, import_jsx_runtime6.jsxs)(Ld.Root, {
    gap: 0,
    shadow: "filterShadow",
    hasRadius: true,
    background: "neutral0",
    children: [
      (0, import_jsx_runtime6.jsxs)(Ld.Item, {
        xs: 12,
        col: 7,
        paddingTop: 6,
        paddingBottom: 6,
...
//# sourceMappingURL=chunk-OA54ENVU.js.map
