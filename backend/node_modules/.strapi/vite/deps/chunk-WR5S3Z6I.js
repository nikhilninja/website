    ...
    (0, import_jsx_runtime.jsxs)(Overlay, {
      ...
      children: [
        ...
        displayedIcon === "time" && (0, import_jsx_runtime.jsx)(IconBox, {
          ...
          background: "primary100",
          borderColor: "primary200",
          children: (0, import_jsx_runtime.jsx)(l5, {
            width: "4rem",
            height: "4rem"
          })
        }),
        (0, import_jsx_runtime.jsx)(S, {
          marginTop: 2,
          children: (0, import_jsx_runtime.jsx)(Oa, {
  ...
  reducers: {
    ...
    addAttribute: (state, action) => {
      ...
      if (attribute.type === "relation") {
        ...
        const isBidirectionalRelation = relationType !== void 0 && ![
          "oneWay",
          "manyWay"
    ...
    editAttribute: (state, action) => {
      ...
      const previousTargetAttribute = previousTargetAttributeIndex !== -1 ? previousTarget.attributes[previousTargetAttributeIndex] : void 0;
      ...
      const isBidirectionnal = newRelationType !== void 0 && !ONE_SIDE_RELATIONS.includes(newRelationType);
      if (isBidirectionnal) {
        const newTargetAttribute = {
          ...
          ...previousTarget.uid === newTarget.uid && (previousTargetAttribute == null ? void 0 : previousTargetAttribute.conditions) ? {
...
var customFieldDefaultOptionsReducer = (acc, option) => {
  if (option.items !== void 0) {
    return option.items.reduce((currentAcc, item) => customFieldDefaultOptionsReducer(currentAcc, item), acc);
  }
  if ("defaultValue" in option && option.name !== void 0) {
...
var shouldPluralizeName = (nature) => nature !== void 0 && [
  "manyToMany",
  "oneToMany",
  "manyWay"
].includes(nature) ? 2 : 1;
var shouldPluralizeTargetAttribute = (nature) => nature !== void 0 && [
  "manyToMany",
  "manyToOne"
].includes(nature) ? 2 : 1;
...
var slice2 = createSlice({
  ...
  reducers: {
    onChange: (state, action) => {
      ...
      const hasDefaultValue = obj.default !== void 0;
      if (hasDefaultValue && keys.length === 1 && keys.includes("type")) {
        const previousType = obj.type;
        if (previousType !== void 0 && [
          "date",
          "datetime",
          "time"
    ...
    resetPropsAndSaveCurrentData: (state, action) => {
      ...
      if ((componentToCreate == null ? void 0 : componentToCreate.displayName) === void 0 || componentToCreate.category === void 0) {
        return initialState2;
      }
      const modifiedData = {
...
//# sourceMappingURL=chunk-WR5S3Z6I.js.map
